...
class DiscoveredDisplayAssignmentManager:
    ...
    def unassign_scene(self, display_id: str) -> Optional[str]:
        """
    ...
    def get_assigned_scene(self, display_id: str) -> Optional[str]:
        """
    ...
    def get_assignment_info(self, display_id: str) -> Optional[Dict[str, str]]:
        """
