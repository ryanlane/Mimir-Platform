...
class Channel(Base):
    ...
    # Indexes (created_at and schema_version are indexed via their Column
    # definitions above; redeclaring them here collides on the auto-generated
    # index names when the schema is created from metadata)
    __table_args__ = (
...
class Scene(Base):
    ...
    # Indexes (content_epoch and update_strategy are indexed via their Column
    # definitions above; redeclaring them here collides on the auto-generated
    # index names when the schema is created from metadata)
    __table_args__ = (
