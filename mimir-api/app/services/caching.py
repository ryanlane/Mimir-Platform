...
class CacheService:
    ...
    def __init__(self):
        ...
        self.metrics_last_updated: datetime | None = None
    ...
    def set_cache(self, key: str, value: Any, ttl_seconds: int | None = None):
    ...
    def get_websocket_status(self) -> dict[str, Any] | None:
    ...
    def clear_rate_limits(self, identifier: str | None = None):
