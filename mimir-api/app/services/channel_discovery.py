...
class ChannelDiscoveryService:
    ...
    def load_channel_config(self, channel_path: Path) -> dict[str, Any] | None:
    ...
    def load_channel_class(self, channel_path: Path) -> Any | None:
    ...
    def _find_channel_class(self, module: Any, channel_name: str) -> type | None:
    ...
    def get_channel_instance(self, channel_id: str) -> Any | None:
