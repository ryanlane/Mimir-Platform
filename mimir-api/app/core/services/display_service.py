...
class DisplayService:
    ...
    def get_display_client_by_id(self, client_id: str) -> Optional[DisplayClient]:
    ...
    def update_display_client(self, client_id: str, client_data: Dict[str, Any]) -> Optional[DisplayClient]:
