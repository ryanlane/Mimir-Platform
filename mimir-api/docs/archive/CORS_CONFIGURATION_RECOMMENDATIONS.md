...
// ✅ Recommended (working)
Access-Control-Allow-Origin: http://localhost:3000, http://oak:3000
Access-Control-Allow-Credentials: true
...
```bash
# Development
CORS_ORIGINS=http://localhost:3000,http://oak:3000,http://127.0.0.1:3000

# Production  
CORS_ORIGINS=https://your-mimir-frontend.com,https://admin.mimir-platform.com

# Local network (for testing)
CORS_ORIGINS=http://oak:3000,http://192.168.1.*:3000
```
...
curl -H "Origin: http://oak:3000" \
     ...
     -X OPTIONS \
     http://oak:5000/api/channels/photo-frame/upload
...
fetch('http://oak:5000/api/channels/photo-frame/images', {
  credentials: 'include'
})
...
- Development: `http://localhost:3000`, `http://oak:3000`
